            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="section-title text-left">
                        <h5 class="section-sub-title" id="last-blogs">Ultimos Blogs</h5>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-5 col-lg-6 col-md-6">
                    <div class="blog-singele-box">
                        <div class="blog-thumb">
                            <img src="http://localhost/template/solutek-demo/assets/images/blog1.png" alt="blog1">
                        </div>
                ...
                <div class="col-xl-7 col-lg-6 col-md-6">
                    <div class="blog-singele-box-tow">
                        <div class="blog-thumb-tow">
                            <img src="http://localhost/template/solutek-demo/assets/images/blog2.png" alt="blog1">
                        </div>
                    ...
                    <div class="blog-singele-box-tow">
                        <div class="blog-thumb-tow">
                            <img src="http://localhost/template/solutek-demo/assets/images/blog3.png" alt="blog1">
                        </div>
                        <div class="blog-content-tow">
                            <h3 class="blog-title-two"><a href="blog-details.html">How to Create Modern Web Site For Your Business..</a></h3>
                            <p class="blog-tex-tow">Appropriatel promote enterprise-wide throuh in information
